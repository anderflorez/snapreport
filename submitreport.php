			...
			<div class="container">    
				...
				<!-- Form -->
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="inputName">Report Name</label>
						<div class="col-sm-10">
							<input id="inputName" name="inputName" class="form-control" type="text" placeholder="Report Name" required autofocus>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea class="form-control" id="description" name="description" placeholder="Please enter a brief description of the issue, exact location, etc." required autofocus></textarea>
						</div>
					</div>
					<div class="form-group">
