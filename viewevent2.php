...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<![endif]-->
        ...
        <div class="log_out"> <big><a href="profile.php">Home <span class="menu-icon"><i class="fa fa-angle-double-right fa-fw"></i></span></a></big> </div>
        <hr>
	</head>
	<body>
		...
		<div id="fh5co-page">
			...
			<div class="jumbotron">
			<h2>Events<br><small>View previously submitted Events</small></h2><br><br>
			<div class="container">    
				<div class="row">
...
$sql = "SELECT * FROM events LEFT JOIN users on events.userid = users.userid ORDER BY date DESC";
		...
		if ($result->num_rows > 0) 
		{
    		...
    		while($row = $result->fetch_assoc()) 
    		{
        			...
        			echo '<div class="col-md-4 col-sm-4"><div class="services animate-box">
						<span><div class="body"><img src="uploads/' . $row['photo'] . '" width="250px" height="250px"></div></i></span><p>' .
						 $row["name"] . '</p><i>' . 
						 $row["description"] . '<br>' .
						 $row["category"] . '<br>' .
						 $row["location"] . '<br>' .
  ...
  <input type="checkbox" name="vehicle" value="Pending"> Pending<br>
  <input type="checkbox" name="vehicle" value="Completed" checked>Completed<br>
