  ...
  <!-- 
	...
	<body>
		...
		<div id="fh5co-page">
			...
			<div class="jumbotron">
			<h2>My Events<br><small>View your previously submitted events</small></h2><br><br>

		<?php	
		
		$userid = $_SESSION['userid'];
		$sql = "SELECT * FROM events WHERE userid = '{$userid}' ORDER BY date DESC";
