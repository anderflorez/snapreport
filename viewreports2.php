  ...
  <!-- 
	...
	<body>
		...
		<div id="fh5co-page">
			...
			<div class="jumbotron">
			<h2>My Reports<br><small>View your previously submitted reports</small></h2><br><br>
			<div class="container">    
				<div class="row">
		...
		if ($result->num_rows > 0) 
		{
    		...
    		while($row = $result->fetch_assoc()) 
    		{
				  ...
				  echo "<input type=\"hidden\" name=\"rid[]\" value=\"{$row["rid"]}\">
                        <input type=\"checkbox\" name=\"completed[]\" value=\"{$row["rid"]}\" ".($row["status"] == 'completed' ? 'checked' : '').">Completed
</i></div></div>";
    		...
    		echo "<input type=\"submit\" name=\"submit\" value=\"Submit\"></div></div>";
		} 
		else 
		{
    		echo "0 results";
